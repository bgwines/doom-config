(custom-set-variables
 ...
 '(package-selected-packages '(scad-mode helm-swoop symbol-navigation-hydra))
 '(magit-todos-insert-after '(bottom) nil nil "Changed by setter of obsolete option `magit-todos-insert-at'")
 '(package-selected-packages '(ultra-scroll helm-swoop symbol-navigation-hydra))
...
(custom-set-faces
 ...
 '(company-scrollbar-bg ((t (:background "#2bd12f784561"))) t)
 '(company-scrollbar-fg ((t (:background "#21e824bc35b0"))) t)
 ...
 '(company-tooltip-scrollbar-thumb ((t (:background "#21e824bc35b0"))))
 '(company-tooltip-scrollbar-track ((t (:background "#2bd12f784561"))))
